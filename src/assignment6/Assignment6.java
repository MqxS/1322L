...
public class Assignment6 {
    ...
    static {
        cocaineAndMethPenalties.put(0d, "Up to 3 years in prison");
        cocaineAndMethPenalties.put(1d, "1 - 8 years in prison");
        cocaineAndMethPenalties.put(4d, "1 - 15 years in prison");
        cocaineAndMethPenalties.put(28d, "Minimum 10 years, $200,000 fine");
        cocaineAndMethPenalties.put(200d, "Minimum 15 years, $300,000 fine");
        cocaineAndMethPenalties.put(400d, "Minimum 25 years, $1,000,000 fine");
    }

    private static final TreeMap<Double, String> marijuanaPenalties = new TreeMap<>();
    static {
        marijuanaPenalties.put(0.0, "Misdemeanor");
        marijuanaPenalties.put(28.35, "1 - 10 years in prison");
        marijuanaPenalties.put(4535.0, "Minimum 5 years, $100,000 fine");
        marijuanaPenalties.put(907184.7, "Minimum 7 years, $250,000 fine");
        marijuanaPenalties.put(4535924.0, "Minimum 15 years, $1,000,000 fine");
    }
